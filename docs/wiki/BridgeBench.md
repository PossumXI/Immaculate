...
Generated at: `2026-05-13T18:17:15.790Z`
...
- parse success: `4/4`
- average latency: `80069.37 ms`
- P95 latency: `129766.05 ms`

## Bridge Runtime Lane

- pack: `substrate-readiness`
- suite: `immaculate-benchmark-2026-05-13T18-17-02-437Z`
- failed assertions: `0`
...
- actuation-serial-transport-registered: `pass` | target `registered serial-json transport with vendor/model and heartbeat policy` | actual `atx-fnv1a-76d954cf:http2-json:immaculate-labs:healthy, atx-fnv1a-bda83ef9:serial-json:immaculate-labs:healthy, atx-fnv1a-84a3e35b:udp-osc:generic:healthy`
...
- actuation-http2-transport-registered: `pass` | target `registered http2-json transport with vendor/model and heartbeat policy` | actual `atx-fnv1a-76d954cf:http2-json:immaculate-labs:haptic-rpc-s2:20/5000:healthy, atx-fnv1a-bda83ef9:serial-json:immaculate-labs:haptic-bridge-s1:20/5000:healthy, atx-fnv1a-84a3e35b:udp-osc:generic:udp-osc:5000/15000:healthy`
