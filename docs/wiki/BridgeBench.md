...
Generated at: `2026-04-14T11:41:22.020Z`
...
- parse success: `4/4`
- average latency: `21628.1 ms`
- P95 latency: `44569.1 ms`

### gemma3:4b

- vendor: `Google DeepMind`
- parse success: `4/4`
- average latency: `12061.27 ms`
- P95 latency: `13535.81 ms`

### qwen3:8b

- vendor: `Alibaba Cloud`
- parse success: `4/4`
- average latency: `44937.37 ms`
- P95 latency: `109358.96 ms`

## Bridge Runtime Lane

- pack: `substrate-readiness`
- suite: `immaculate-benchmark-2026-04-14T11-41-14-991Z`
- failed assertions: `0`
...
- actuation-serial-transport-registered: `pass` | target `registered serial-json transport with vendor/model and heartbeat policy` | actual `atx-fnv1a-a9b66326:http2-json:immaculate-labs:healthy, atx-fnv1a-3849355a:serial-json:immaculate-labs:healthy, atx-fnv1a-b75165b2:udp-osc:generic:healthy`
...
- actuation-http2-transport-registered: `pass` | target `registered http2-json transport with vendor/model and heartbeat policy` | actual `atx-fnv1a-a9b66326:http2-json:immaculate-labs:haptic-rpc-s2:20/5000:healthy, atx-fnv1a-3849355a:serial-json:immaculate-labs:haptic-bridge-s1:20/5000:healthy, atx-fnv1a-b75165b2:udp-osc:generic:udp-osc:5000/15000:healthy`
