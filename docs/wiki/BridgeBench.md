...
Generated at: `2026-05-07T04:12:53.126Z`
Release: `0.1.0+b648694`
Repo commit: `b648694`
...
- parse success: `4/4`
- average latency: `41585.2 ms`
- P95 latency: `51081.94 ms`

## Bridge Runtime Lane

- pack: `substrate-readiness`
- suite: `immaculate-benchmark-2026-05-07T04-12-14-478Z`
- failed assertions: `0`
...
- actuation-serial-transport-registered: `pass` | target `registered serial-json transport with vendor/model and heartbeat policy` | actual `atx-fnv1a-999acd23:http2-json:immaculate-labs:healthy, atx-fnv1a-be2f78b2:serial-json:immaculate-labs:healthy, atx-fnv1a-9fce324b:udp-osc:generic:healthy`
...
- actuation-http2-transport-registered: `pass` | target `registered http2-json transport with vendor/model and heartbeat policy` | actual `atx-fnv1a-999acd23:http2-json:immaculate-labs:haptic-rpc-s2:20/5000:healthy, atx-fnv1a-be2f78b2:serial-json:immaculate-labs:haptic-bridge-s1:20/5000:healthy, atx-fnv1a-9fce324b:udp-osc:generic:udp-osc:5000/15000:healthy`
...
- temporal suite: `immaculate-benchmark-2026-04-29T01-57-42-865Z`
- failed assertions: `0`
- workflow wall-clock P95: Immaculate `28.57 ms` / Temporal `n/a ms`
