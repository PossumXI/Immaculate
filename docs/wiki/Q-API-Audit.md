...
- Session: `arobi-q-proof-20260419`
- Decision trace: `trace-0b2f27a38ba781e0`
- Trace hash: `ba6b5b7464ff11e5d27f73256924ff53e7e72666ae7538608e3f06d2f45bb824`
- Policy digest: `43c979c12c2161bdea80fce1571ff558784c524fec3418b36d259d03e826fec3`
- Evidence digest: `2a7e882e79f4490f3ea8c529e9125afb350a8ac5440e371331669675692f5599`
- Model name: `Q`
- Release build: `0.1.0+6fc8e11`
- Training bundle: `q-defsec-code-longctx-harbor-opt-2384cf5-bench-v23-5ed19b9-286326ce`
- Status: `completed`
- Latency: `46045` ms
- Parse success: `True`
- Governance pressure: `elevated`
- Preview: ROUTE: cognitive REASON: The local governed lane is healthy, allowing for cognitive processing of the request. COMMIT: Proceed with cognitive processing of the sensor-array data.
