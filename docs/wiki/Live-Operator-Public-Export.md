...
- Live mission readiness: `fresh` via `docs/wiki/Live-Mission-Readiness.json` at `2026-05-13T20:22:02.597Z` - fresh (2m old, budget 24h)
- Live operator activity: `fresh` via `docs/wiki/Live-Operator-Activity.json` at `2026-05-13T20:22:13.578Z` - fresh (1m old, budget 24h)
- Arobi live ledger receipt: `fresh` via `docs/wiki/Arobi-Live-Ledger-Receipt.json` at `2026-05-13T20:21:53.430Z` - fresh (2m old, budget 24h)
...
- Verified ledger entries: `unknown`
- Public height: `59370`
- Orchestration profile: `immaculate-supervised-operator-loop`
- Q auth mode: `oci_iam`
- Last checked: `2026-05-13T20:23:36.264Z`
...
- Status: `ok`
- Kind: `showcase`
- Timestamp: `2026-05-13T20:23:36.264Z`
...
- Status: `ok`
- Kind: `agent`
- Timestamp: `2026-05-13T20:22:13.578Z`
- Source: `immaculate.live_operator_activity`
...
- Summary: status=ready; gateway=true; guilds=1; health 200; updated 28s ago (budget 900s)
...
- Status: `warning`
- Kind: `ledger`
- Timestamp: `2026-05-13T20:21:53.430Z`
- Source: `immaculate.arobi_live_ledger`
- Summary: public ledger version 3.3.1 on block 59,370 with unknown visible aggregate entries; fabric source nysus
