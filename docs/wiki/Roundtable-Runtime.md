...
- Generated: 2026-04-20T21:36:25.174Z
...
- Harness URL: `http://127.0.0.1:50978`
- Scenario count: `3`
- Failed assertions: `0`
- Repo coverage P50: `3`
...
- Seed latency P95: `40279.38` ms
- Mediation latency P95: `72739.03` ms
- Runner path latency P95: `113042.33` ms
...
- Summary: Roundtable single-lane plan across 3 repo(s) with 3 isolated agent action(s); 3 ready for immediate worktree materialization. Execution bundles prepared for 3/3 lane(s); 3/3 lane(s) remain authority-bound and ready for isolated agent work. Repo audit receipts captured for 3/3 lane(s).
