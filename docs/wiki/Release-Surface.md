...
- Generated: 2026-04-18T01:41:13.234Z
- Immaculate release: `0.1.0+4d81044`
...
- Q hybrid session: `q-hybrid-harbor-opt-2384cf5-bench-v15`

## What This Means In Plain English

- Immaculate build `0.1.0+4d81044` is the current repo build stamp.
- Q is the only public model name used across the repo, and it is built on `Gemma 4`.
- The latest tracked Q training bundle is `q-defsec-code-longctx-harbor-opt-2384cf5-bench-v15-4d81044-ac6ea0d1`, tied to dataset `.training-output/q/q-defsec-code-longctx-harbor-opt-2384cf5-bench-v15.jsonl` and config/provenance captured in `.training-output/q/latest-training-lock.json`.
- The latest hybrid session is `q-hybrid-harbor-opt-2384cf5-bench-v15`, with local lane `ready` and cloud lane `ready` on provider `hf_jobs`.
...
- Q readiness gate: `2026-04-18T01:31:47.686Z` via `docs/wiki/Q-Readiness-Gate.json`
- Q gateway validation: `2026-04-17T10:12:01.155Z` via `docs/wiki/Q-Gateway-Validation.json`
- Q gateway substrate: `2026-04-18T01:33:34.425Z` via `docs/wiki/Q-Gateway-Substrate.json`
- Q mediation drift: `2026-04-18T01:33:34.477Z` via `docs/wiki/Q-Mediation-Drift.json`
- Q API audit: `2026-04-17T10:09:27Z` via `docs/wiki/Q-API-Audit.json`
- Q hybrid training: `2026-04-18T01:28:37Z` via `docs/wiki/Q-Hybrid-Training.json`
- HF Jobs training: `2026-04-18T01:29:44Z` via `docs/wiki/HF-Jobs-Training.json`
- Colab free training: `2026-04-18T01:29:32Z` via `docs/wiki/Colab-Free-Training.json`
- Cloudflare Q inference: `2026-04-17T10:10:15Z` via `docs/wiki/Cloudflare-Q-Inference.json`
- OCI GPU advisor: `2026-04-18T01:28:37Z` via `docs/wiki/OCI-GPU-Advisor.json`
- OCI region capacity: `2026-04-17T02:02:24Z` via `docs/wiki/OCI-Region-Capacity.json`
- Q benchmark corpus: `2026-04-18T01:28:25Z` via `docs/wiki/Q-Benchmark-Corpus.json`
- Q failure corpus: `2026-04-18T01:28:24Z` via `docs/wiki/Q-Failure-Corpus.json`
- Q benchmark promotion: `2026-04-18T01:28:24Z` via `docs/wiki/Q-Benchmark-Promotion.json`
- W&B benchmark export: `2026-04-17T10:28:04.992947+00:00` via `docs/wiki/Benchmark-Wandb-Export.json`
- Harbor terminal bench: `2026-04-18T01:29:50.329Z` via `docs/wiki/Harbor-Terminal-Bench.json`
- Terminal-Bench receipt: `2026-04-18T01:29:50.255Z` via `docs/wiki/Terminal-Bench-Receipt.json`
...
- Lock generated: `2026-04-18T01:28:24Z`
- Run name: `q-defsec-code-longctx-harbor-opt-2384cf5-bench-v15`
- Training dataset rows: `109`
- Training dataset SHA-256: `ac6ea0d1d16e5eb854ddb997be65d2a521d623837760016b75c3cff42b61afe0`
...
- Session path: `.training-output/q/sessions/q-hybrid-harbor-opt-2384cf5-bench-v15/hybrid-session.json`
- Session generated: `2026-04-18T01:28:37Z`
- Local lane status: `ready`
- Cloud lane status: `ready`
- Cloud provider: `hf_jobs`
- Immaculate orchestration bundle: `immaculate-orchestration-4d81044-ec4b3cb6`
