...
- Generated: 2026-04-17T10:18:45.735Z
- Immaculate release: `0.1.0+848d44f`
...
- Q hybrid session: `q-hybrid-harbor-opt-2384cf5-bench-v13`

## What This Means In Plain English

- Immaculate build `0.1.0+848d44f` is the current repo build stamp.
- Q is the only public model name used across the repo, and it is built on `Gemma 4`.
- The latest tracked Q training bundle is `q-defsec-code-longctx-harbor-opt-2384cf5-bench-v13-848d44f-beff091d`, tied to dataset `.training-output/q/q-defsec-code-longctx-harbor-opt-2384cf5-bench-v13.jsonl` and config/provenance captured in `.training-output/q/latest-training-lock.json`.
- The latest hybrid session is `q-hybrid-harbor-opt-2384cf5-bench-v13`, with local lane `ready` and cloud lane `ready` on provider `hf_jobs`.
...
- Q readiness gate: `2026-04-17T10:12:18.929Z` via `docs/wiki/Q-Readiness-Gate.json`
...
- Q hybrid training: `2026-04-17T10:11:18Z` via `docs/wiki/Q-Hybrid-Training.json`
- HF Jobs training: `2026-04-17T10:09:58Z` via `docs/wiki/HF-Jobs-Training.json`
- Colab free training: `2026-04-17T10:09:51Z` via `docs/wiki/Colab-Free-Training.json`
- Cloudflare Q inference: `2026-04-17T10:10:15Z` via `docs/wiki/Cloudflare-Q-Inference.json`
- OCI GPU advisor: `2026-04-17T10:11:18Z` via `docs/wiki/OCI-GPU-Advisor.json`
- OCI region capacity: `2026-04-17T02:02:24Z` via `docs/wiki/OCI-Region-Capacity.json`
- Q benchmark corpus: `2026-04-17T10:18:30Z` via `docs/wiki/Q-Benchmark-Corpus.json`
- Q failure corpus: `2026-04-17T10:18:30Z` via `docs/wiki/Q-Failure-Corpus.json`
- Q benchmark promotion: `2026-04-17T09:49:30Z` via `docs/wiki/Q-Benchmark-Promotion.json`
- W&B benchmark export: `2026-04-17T00:58:35.193636+00:00` via `docs/wiki/Benchmark-Wandb-Export.json`
- Harbor terminal bench: `2026-04-17T10:09:10.958Z` via `docs/wiki/Harbor-Terminal-Bench.json`
...
- Q benchmark sweep (60m): `2026-04-17T07:13:20.835Z` via `docs/wiki/Q-Benchmark-Sweep-60m.json`

## Q Training Bundle

- Lock path: `.training-output/q/latest-training-lock.json`
- Lock generated: `2026-04-17T09:49:31Z`
- Run name: `q-defsec-code-longctx-harbor-opt-2384cf5-bench-v13`
- Training dataset rows: `100`
- Training dataset SHA-256: `beff091d4d9ace3fcbfc1552b1f3bea3feff5e65fdf9a6cf65b719973b4f812f`
...
- Session path: `.training-output/q/sessions/q-hybrid-harbor-opt-2384cf5-bench-v13/hybrid-session.json`
- Session generated: `2026-04-17T10:11:18Z`
- Local lane status: `ready`
- Cloud lane status: `ready`
- Cloud provider: `hf_jobs`
- Immaculate orchestration bundle: `immaculate-orchestration-848d44f-6e631f6b`
