...
- `GET /api/intelligence/assessments` reads the governed assessment ledger under `cognitive-trace-read` consent.
- `POST /api/intelligence/assessments/run` manually records a governed PoI assessment under `cognitive-execution` consent.
