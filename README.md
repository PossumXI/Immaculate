...
- the public pressure showcase is deliberately narrow: it can surface ledger health, governed fleet counts, orchestration availability, and Q readiness for a supervised observer window, while sealed `00` records stay private and the public edge closes again after the showcase
