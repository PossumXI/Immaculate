...
- the live Arobi public node receipt is now green on the real `v3.3.1` lane: [docs/wiki/Arobi-Live-Ledger-Receipt.md](docs/wiki/Arobi-Live-Ledger-Receipt.md) records a fresh `control_fabric` entry at `2026-04-20T02:26:54Z`, public ledger entries moving `396 -> 397`, and a receipt match back to the latest supervised fabric-audit rerun
